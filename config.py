...
# Platform configs
z_ini = 0       # focused at 8.5 mm, range from 0 to 10 mm. More than 10, angular started to torture 
...
def config_andor(camera):
    if type(camera) == type(Andor3()):
        ...
        # ROI settomg
        camera.AOIHeight = 240
        camera.AOITop = 980      #? The "Top" might be typo, it seems work as "bottom" in the Solis.
        camera.AOIWidth = 240
        camera.AOILeft = 1160
        camera.AOIHBin = 1
        camera.AOIVBin = 1
